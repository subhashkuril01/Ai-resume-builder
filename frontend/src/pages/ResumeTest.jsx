              ...
              {!selectedTest ? (
                ...
                <>
                  ...
                  {selectedTest.status !== 'submitted' ? (
                    ...
                    <div className="animate-fade-up flex flex-col" style={{ height: 'calc(100vh - 200px)', minHeight: '870px' }}>
                      {/* Tab Navigation — stays fixed at top */}
                      <div className="card p-2 border-border/50 bg-white/[0.01] flex gap-2 shrink-0 mb-6">
                        {[
