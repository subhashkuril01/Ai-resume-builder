export const TEMPLATE_CATALOG = [
  ...
  { id: 'minimal', label: 'Minimal', color: '#64748b', desc: 'Ultra-clean, whitespace-forward design. Lets your content speak loudly.', tags: ['Minimal', 'Any Industry', 'Creative', 'Senior'], featured: true },
  ...
  { id: 'minimalist', label: 'Minimalist Monochrome', color: '#000000', desc: 'Black and white elegance. Ultra-professional with maximum readability.', tags: ['Minimal', 'Professional', 'Formal', 'Legal'] },
  ...
  { id: 'minimalist2', label: 'Ultra Minimal', color: '#9ca3af', desc: 'Extreme minimalism with maximum whitespace. True essence of simplicity.', tags: ['Minimal', 'Simple', 'Clean', 'Zen'] },
